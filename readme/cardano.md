...
It uses BIP-0039 mnemonics, but the seed is just the initial entropy. For this reason, the *CardanoIcarusSeedGenerator*
...
Like in the Byron case, the *CardanoIcarusSeedGenerator* class shall be used to generate the seed.
